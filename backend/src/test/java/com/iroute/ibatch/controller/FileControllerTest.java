...
class FileControllerTest {
    ...
    @MockBean
    private com.iroute.ibatch.application.usecase.FileProgressTracker fileProgressTracker;

    @MockBean
    private com.iroute.ibatch.infrastructure.file.InputFileService inputFileService;
